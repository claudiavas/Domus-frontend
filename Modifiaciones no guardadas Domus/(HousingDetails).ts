...
import { getMunicipalities } from '../../apiService/geoApiService';
import { getPopulations } from '../../apiService/geoApiService';
import { getNeighborhoods } from '../../apiService/geoApiService';
import { getZipCodes } from '../../apiService/geoApiService';
import { getRoads } from '../../apiService/geoApiService';
...
export const HousingDetails = () => {
  ...
  // const locationText = [
  //   findItemNameByCode(provinces, housingData.province, "PRO"),
  //   findItemNameByCode(municipalities, housingData.municipality, "DMUN50"),
  //   findItemNameByCode(populations, housingData.population, "NENTSI50"),
  //   findItemNameByCode(neighborhoods, housingData.neighborhood, "NNUCLE50")
  // ]
  //   .filter(Boolean)
