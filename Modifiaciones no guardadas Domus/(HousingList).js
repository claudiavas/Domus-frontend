...
export function HousingList({myHousingSwitch}) {
  ...
  // sconsole.log("myHousingSwitch", myHousingSwitch);
    ...
    <div>
      ...
      {housingFiltrado.map((house) => (
        <HouseCard
          ...
          selectedMunicipality={house.municipality}
          selectedPopulation={house.population}
          selectedNeighborhood={house.neighborhood}
